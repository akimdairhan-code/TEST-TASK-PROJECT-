...
func (m *AttemptAnswerMutation) SetAttemptID(u uuid.UUID) {
	m.attempt = &u
}

// AttemptID returns the value of the "attempt_id" field in the mutation.
func (m *AttemptAnswerMutation) AttemptID() (r uuid.UUID, exists bool) {
	v := m.attempt
	if v == nil {
		return
	}
...
// OldAttemptID returns the old "attempt_id" field's value of the AttemptAnswer entity.
// If the AttemptAnswer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttemptAnswerMutation) OldAttemptID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AttemptAnswerMutation) ResetAttemptID() {
	m.attempt = nil
}

// SetQuestionID sets the "question_id" field.
func (m *AttemptAnswerMutation) SetQuestionID(u uuid.UUID) {
	m.question = &u
}

// QuestionID returns the value of the "question_id" field in the mutation.
func (m *AttemptAnswerMutation) QuestionID() (r uuid.UUID, exists bool) {
	v := m.question
	if v == nil {
		return
	}
...
// OldQuestionID returns the old "question_id" field's value of the AttemptAnswer entity.
// If the AttemptAnswer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttemptAnswerMutation) OldQuestionID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldQuestionID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetQuestionID resets all changes to the "question_id" field.
func (m *AttemptAnswerMutation) ResetQuestionID() {
	m.question = nil
}

// SetUserText sets the "user_text" field.
func (m *AttemptAnswerMutation) SetUserText(s string) {
	m.user_text = &s
}

// UserText returns the value of the "user_text" field in the mutation.
func (m *AttemptAnswerMutation) UserText() (r string, exists bool) {
	v := m.user_text
	if v == nil {
		return
	}
...
// OldUserText returns the old "user_text" field's value of the AttemptAnswer entity.
// If the AttemptAnswer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttemptAnswerMutation) OldUserText(ctx context.Context) (v *string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AttemptAnswerMutation) ClearUserText() {
	m.user_text = nil
	m.clearedFields[attemptanswer.FieldUserText] = struct{}{}
}

// UserTextCleared returns if the "user_text" field was cleared in this mutation.
func (m *AttemptAnswerMutation) UserTextCleared() bool {
	_, ok := m.clearedFields[attemptanswer.FieldUserText]
	return ok
}

// ResetUserText resets all changes to the "user_text" field.
func (m *AttemptAnswerMutation) ResetUserText() {
	m.user_text = nil
	delete(m.clearedFields, attemptanswer.FieldUserText)
}

// SetAnswerID sets the "answer_id" field.
func (m *AttemptAnswerMutation) SetAnswerID(u uuid.UUID) {
	m.answer = &u
}

// AnswerID returns the value of the "answer_id" field in the mutation.
func (m *AttemptAnswerMutation) AnswerID() (r uuid.UUID, exists bool) {
	v := m.answer
	if v == nil {
		return
	}
...
// OldAnswerID returns the old "answer_id" field's value of the AttemptAnswer entity.
// If the AttemptAnswer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttemptAnswerMutation) OldAnswerID(ctx context.Context) (v *uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AttemptAnswerMutation) ClearAnswerID() {
	m.answer = nil
	m.clearedFields[attemptanswer.FieldAnswerID] = struct{}{}
}

// AnswerIDCleared returns if the "answer_id" field was cleared in this mutation.
func (m *AttemptAnswerMutation) AnswerIDCleared() bool {
	_, ok := m.clearedFields[attemptanswer.FieldAnswerID]
	return ok
}

// ResetAnswerID resets all changes to the "answer_id" field.
func (m *AttemptAnswerMutation) ResetAnswerID() {
	m.answer = nil
	delete(m.clearedFields, attemptanswer.FieldAnswerID)
}

// ClearAttempt clears the "attempt" edge to the Attempt entity.
func (m *AttemptAnswerMutation) ClearAttempt() {
	m.clearedattempt = true
	m.clearedFields[attemptanswer.FieldAttemptID] = struct{}{}
}
...
func (m *AttemptAnswerMutation) ClearQuestion() {
	m.clearedquestion = true
	m.clearedFields[attemptanswer.FieldQuestionID] = struct{}{}
}
...
func (m *AttemptAnswerMutation) AnswerCleared() bool {
	return m.AnswerIDCleared() || m.clearedanswer
}
...
func (m *AttemptAnswerMutation) Fields() []string {
	fields := make([]string, 0, 4)
	if m.attempt != nil {
		fields = append(fields, attemptanswer.FieldAttemptID)
	}
	if m.question != nil {
		fields = append(fields, attemptanswer.FieldQuestionID)
	}
	if m.user_text != nil {
		fields = append(fields, attemptanswer.FieldUserText)
	}
	if m.answer != nil {
		fields = append(fields, attemptanswer.FieldAnswerID)
	}
	return fields
}
...
func (m *AttemptAnswerMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(attemptanswer.FieldUserText) {
		fields = append(fields, attemptanswer.FieldUserText)
	}
	if m.FieldCleared(attemptanswer.FieldAnswerID) {
		fields = append(fields, attemptanswer.FieldAnswerID)
	}
	return fields
}
